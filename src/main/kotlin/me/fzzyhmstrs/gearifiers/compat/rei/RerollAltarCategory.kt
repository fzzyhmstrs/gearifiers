...
/*        val outputSlotBackground =
        ...
        if (GearifiersConfig.modifiers.enableRerollXpCost){
            ...
            widgets.add(text2)
            val orb1 = Widgets.withTooltip(XpOrbWidget(bounds.x + xOffset + 10, bounds.y + yOffset + 20,GearifiersConfig.modifiers.firstRerollXpCost),AcText.translatable("emi.category.gearifiers.reroll_altar.tooltip_1"))
            widgets.add(orb1)
            val orb2 = Widgets.withTooltip(XpOrbWidget(bounds.x + xOffset + 41, bounds.y + yOffset + 20,GearifiersConfig.modifiers.addedRerollXpCostPerRoll),AcText.translatable("emi.category.gearifiers.reroll_altar.tooltip_2"))
            widgets.add(orb2)
        }
